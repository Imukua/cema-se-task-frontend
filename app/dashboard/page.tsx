          ...
          <CardContent className="p-4 flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  href="/programs"
                  className="text-xs text-teal-500 hover:underline flex items-center"
                >
                  <ArrowUpRight className="h-3 w-3" />
                </Link>
              </div>
            ...
            <div className="mt-3">
              <Link href="/clients/new">
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full border-blue-200 text-blue-600 text-xs h-8"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            <Link href="/enrollments/new">
              <Button className="w-full bg-teal-600 hover:bg-teal-700 text-xs h-8 justify-start">
                <ClipboardCheck className="h-3.5 w-3.5 mr-2" /> Create
                Enrollment
              </Button>
            </Link>
